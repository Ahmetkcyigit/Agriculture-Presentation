...
namespace BusinessLayer.ValidationRules
{
    public class ImageValidator : AbstractValidator<Image>
    {
        public ImageValidator()
        {
            ...
            RuleFor(x => x.ImageUrl).NotEmpty().WithMessage("Görsel Başlığını Boş Geçemezsiniz");
            RuleFor(x => x.Title).MaximumLength(30).WithMessage("Lütfen En Fazla 20 Karakter Veri Girişi Yapın");
